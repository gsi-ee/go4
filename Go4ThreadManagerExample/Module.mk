...
$(THRDMNGREXAMP_LIB):   $(THRDMNGREXAMP_O) $(THRDMNGREXAMP_DO)
	@$(MakeLib) $(THRDMNGREXAMP_LIBNAME) "$(THRDMNGREXAMP_O) $(THRDMNGREXAMP_DO)" $(THRDMNGREXAMP_DIR) $(THRDMNGREXAMP_LINKDEF) "$(THRDMNGR_SLIB) $(GO4BASE_SLIB) $(ROOTSYS)/lib/libThread.so"
