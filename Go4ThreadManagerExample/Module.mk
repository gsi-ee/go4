...
$(THRDMNGREXAMP_LIB):   $(THRDMNGREXAMP_O) $(THRDMNGREXAMP_DO)
	@$(MakeLibrary) $(THRDMNGREXAMP_LIBNAME) "$(THRDMNGREXAMP_O) $(THRDMNGREXAMP_DO)" $(THRDMNGREXAMP_DIR) $(THRDMNGREXAMP_LINKDEF) "$(THRDMNGR_LIB) $(GO4BASE_LIB) $(ROOTSYS)/lib/libThread.so"

$(THRDMNGREXAMP_DS): $(THRDMNGREXAMP_H) $(THRDMNGREXAMP_LINKDEF)
	@$(ROOTCINTGO4) $(THRDMNGREXAMP_H) $(THRDMNGREXAMP_LINKDEF)

all-$(THRDMNGREXAMP_NAME):     $(THRDMNGREXAMP_LIB) $(THRDMNGREXAMP_EXE)
