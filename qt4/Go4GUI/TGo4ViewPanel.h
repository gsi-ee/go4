...
enum {kind_None = -1,
    ...
    virtual TGo4Slot * AddDrawObject( TPad * pad, int kind, const char * itemname, TObject * obj, bool owner, const
char * drawopt );
    ...
    virtual QGo4RootCanvas * GetQCanvas();
...
;
    virtual void RedrawGraph( TPad * pad, TGo4Picture * padopt, TGraph * gr, bool scancontent );
