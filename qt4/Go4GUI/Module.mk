...
ifdef withweb
GO4GUI4_QMAKEFLAGS += "HEADERS += ../Go4Web/QWebCanvas.h ../Go4Web/TWebCanvasFull.h" 
GO4GUI4_QMAKEFLAGS += "SOURCES += ../Go4Web/QWebCanvas.cpp ../Go4Web/TWebCanvasFull.cpp" 
GO4GUI4_QMAKEFLAGS += "QT += webengine webenginewidgets" 
GO4GUI4_QMAKEFLAGS += "LIBS += -lROOTWebDisplay -lROOTQt5WebDisplay -lWebGui6" 
