...
GO4SGUI4_LIBNAME    = $(LIB_PREFIX)Go4GUIbis
GO4SGUI4_SLIB       = $(GO4DLLPATH)/$(GO4SGUI4_LIBNAME).$(DllSuf)
GO4SGUI4_LIB        = $(GO4SGUI4_SLIB).$(VERSSUF)
...
GO4GUI4_QTPRO       = $(GO4GUI4_DIR)/go4gui.pro
...
$(GO4SGUI4_LIB): $(GO4GUI4_O) $(GO4GUI4_DO)
	@$(MakeLib) $(GO4SGUI4_LIBNAME) "$(GO4GUI4_O) $(GO4GUI4_DO)" $(GO4DLLPATH)
...
ifneq ($(wildcard $(GO4GUI4_QTPRO)),)
$(GO4GUI4_QTMAKE): $(GO4GUI4_QTPRO) $(GO4GUI4_FORMS)
...
qt4-GUI: $(GO4QT4HEADS) $(BUILDGO4LIBS) $(GO4SGUI4_LIB) qt4-interface qt4-FitGUI $(GO4GUI4_QTMAKE)
	@echo "Generating Qt4 part of the MainGUI..."
	+cd $(GO4GUI4_DIR); $(MAKE) -f $(GO4GUI4_QTMAKE)
