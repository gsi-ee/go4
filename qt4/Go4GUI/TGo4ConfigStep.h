...
class TGo4ConfigStep : public QWidget, public Ui::TGo4ConfigStep
 ...
 public:
    ...
    virtual void ResetSourceWidgets( const QString & name, int timeout );
    virtual void SetFileSource();
    virtual void SetMbsFileSource( QString TagFile, int start, int stop, int interval );
    ...
    virtual int GetSourceSetup( QString & name, int & timeout );
    virtual void GetMbsFileSource( QString & TagFile, int & start, int & stop, int & interval );
