    ...
    : QDialog( parent )
{
   ...
   setupUi(this);
   QObject::connect(MacroListBox, &QListWidget::currentTextChanged, this, &TGo4MacroDialog::setCommand);
   setCommand("Add");
}
...
void TGo4MacroDialog::setCommand( const QString & selection )
{
   if (selection.contains("Add")) {
      ...
      setToolTip("Rebin histogram histo by merging ngroup neighboured channels together. \n If draw=true, display in "
                 "new viewpanel, otherwise just update existing displays ");
      ...
      setToolTip(" Create histogram and fill with contents of histogram histo. \n If draw==true, display in new "
                 "viewpanel, otherwise just update existing displays ");
      ...
      setToolTip(" Do profile to X axis for 2d histogram histo. \n Parameters firstybin, lastybin for y range. \n If "
                 "draw==true, display in new viewpanel, otherwise just update existing displays ");
      ...
      setToolTip(" Scale x axis of histogram histo by linear function. \n Parameters: x'= a1*x + a0. \n If draw==true, "
                 "display in new viewpanel, otherwise just update existing displays ");
