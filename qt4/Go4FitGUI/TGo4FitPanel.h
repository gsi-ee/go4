...
public slots:
    ...
    virtual void Wiz_DataListSelect( int indx );
    virtual void Wiz_DataList_highlighted( int indx );
    virtual void Wiz_ModelListSelect( int indx, bool ontext );
    virtual void Wiz_ModelList_highlighted( int indx );
    ...
    virtual void Wiz_DataList_doubleClicked( Q3ListBoxItem * );
    virtual void Wiz_ModelList_doubleClicked( Q3ListBoxItem * );
    ...
    virtual void Wiz_DataList_clicked( Q3ListBoxItem * );
    virtual void Wiz_DataList_pressed( Q3ListBoxItem * );
    virtual void Wiz_DataList_selected( int indx );
    virtual void Wiz_ModelList_selected( int indx );
    ...
    virtual void Wiz_ModelList_clicked( Q3ListBoxItem * item, const QPoint & pnt );
