...
#include <string>
#include "CompCodec.h"
CompCodec::CompCodec() : TGo4Parameter(),
testmaxi(0),fiReg0(0),fiReg1(0),fiReg2(0),fiReg3(0),test(0),fiValue(0)
{}
CompCodec::CompCodec(const char* name) : TGo4Parameter(name),
testmaxi(0),fiReg0(0),fiReg1(0),fiReg2(0),fiReg3(0),test(0),fiValue(0)
{}
CompCodec::~CompCodec()
{}

void CompCodec::setMpxIndex(UInt_t reg0, UInt_t reg1, UInt_t reg2, UInt_t reg3)
{
int s=0,i;
// bits are inverted!
	fiReg0=reg0;
...
void CompCodec::setMap(Bool_t print){
int i=0,si=0;
// fiStopX
...
void CompCodec::printDetector(UInt_t detector, const char *name){
...
void CompCodec::printDetector(UInt_t *adc, UInt_t n){
	UInt_t i=0,si=0;
	for(i=0;i<n;i++) {
...
UInt_t CompCodec::printMap(UInt_t detector){
int i=0,si=0,n=0;
...
//-----------------------------------------------------------
Bool_t CompCodec::UpdateFrom(TGo4Parameter *pp){
  if(pp->InheritsFrom("CompCodec")) {
    CompCodec * from = (CompCodec *) pp;
