...
//***********************************************************
CompCaliProc::~CompCaliProc()
{
  cout << "Comp> CompCaliProc:   Processed "<<fiEventsProcessed<<
...
//***********************************************************
// this one is used
CompCaliProc::CompCaliProc(const char* name) :
   TGo4EventProcessor(name)
{
  cout << "Comp> CompCaliProc "<<name<<" created" << endl;
...
//-----------------------------------------------------------
void CompCaliProc::CompCalibrate(CompCaliEvent* poutevt)
{

  poutevt->SetValid(kFALSE); // not to store
  fInput    = (CompUnpackEvent* ) GetInputEvent(); // from this
  fiEventsProcessed++;
