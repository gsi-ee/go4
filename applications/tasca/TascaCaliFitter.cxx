...
//***********************************************************
TascaCaliFitter::TascaCaliFitter() : TGo4Parameter(),
LineFitter(0),
Calibrator(0),
fxCalibCurve(0),
fxCalibSpectrum(0)
{}
//***********************************************************
TascaCaliFitter::TascaCaliFitter(const char* name) : TGo4Parameter(name),
LineFitter(0),
Calibrator(0),
fxCalibCurve(0),
fxCalibSpectrum(0)
{
    cout << "Tasca> TascaCaliFitter: " << name << " created" << endl;
}
//***********************************************************
TascaCaliFitter::~TascaCaliFitter(){
	  delete LineFitter;
	  delete Calibrator;
    cout << "Tasca> TascaCaliFitter: " << GetName() << " deleted" << endl;
}
//***********************************************************

void TascaCaliFitter::Setup(TGraph* curve){
	fxCalibCurve=curve;
...
//-----------------------------------------------------------
Bool_t TascaCaliFitter::UpdateFrom(TGo4Parameter *pp){
if(!pp->InheritsFrom("TascaCaliFitter")) {
