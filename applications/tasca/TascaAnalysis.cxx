...
TascaAnalysis::TascaAnalysis(Text_t * input, Int_t type, Int_t port, Text_t * out1, Text_t * out2, Bool_t enable1, Bool_t enable2)
  : fUserFile(0),
    fMbsEvent(0),
    fRawEvent(0),
    fCalEvent(0),
...
// out2:  output file name of second analysis step (*.root)
  cout << "**** TascaAnalysis: Create" << endl;
...
// otherwise we use output event from step 1 (set in factory)
  factory2 = new TascaAnlFact("AnalysisFactory");
  ...
  // if an autosave file is there.
      fPar = new TascaParameter("TascaPar1");
      fPar->frP1 = 100;
      fPar->frP2 = 200;
      AddParameter(fPar);
      fPar = new TascaParameter("TascaPar2");
      fPar->frP1 = 1000;
      fPar->frP2 = 2000;
      AddParameter(fPar);
...
TascaAnalysis::~TascaAnalysis()
{
  cout << "**** TascaAnalysis: Delete" << endl;
}
//***********************************************************
...
{
  cout << "**** TascaAnalysis: PreLoop" << endl;
   ...
   fRawEvent = dynamic_cast<TascaUnpackEvent*> (GetOutputEvent("Unpack"));
   fCalEvent = dynamic_cast<TascaAnlEvent*>    (GetOutputEvent("Analysis"));
   fEvents=0;
   fLastEvent=0;
...
{
  cout << "**** TascaAnalysis: PostLoop" << endl;
