...
const Text_t TGo4AnalysisObjectManager::fgcTOPDYNAMICLIST[]="Go4DynamicList";
const Text_t TGo4AnalysisObjectManager::fgcTOPFOLDER[]="Go4";
const Text_t TGo4AnalysisObjectManager::fgcHISTFOLDER[]="Histograms";
const Text_t TGo4AnalysisObjectManager::fgcDYNFOLDER[]="DynamicLists";
const Text_t TGo4AnalysisObjectManager::fgcCONDFOLDER[]="Conditions";
const Text_t TGo4AnalysisObjectManager::fgcPARAFOLDER[]="Parameters";
const Text_t TGo4AnalysisObjectManager::fgcTREEFOLDER[]="Trees";
const Text_t TGo4AnalysisObjectManager::fgcPICTFOLDER[]="Pictures";
const Text_t TGo4AnalysisObjectManager::fgcCANVFOLDER[]="Canvases";
const Text_t TGo4AnalysisObjectManager::fgcANALYSISFOLDER[]="EventObjects";
const Text_t TGo4AnalysisObjectManager::fgcEVENTFOLDER[]="Events";
const Text_t TGo4AnalysisObjectManager::fgcSRCFOLDER[]="EventSources";
const Text_t TGo4AnalysisObjectManager::fgcSTOREFOLDER[]="EventStores";
const Text_t TGo4AnalysisObjectManager::fgcPROCFOLDER[]="EventProcessors";
const Text_t TGo4AnalysisObjectManager::fgcUSRFOLDER[]="UserObjects";
const Text_t TGo4AnalysisObjectManager::fgcTMPFOLDER[]="Go4-tmp";
...
Bool_t TGo4AnalysisObjectManager::AddObject(TNamed * anything, const Text_t* subfolder, Bool_t replace)
{
...
Bool_t TGo4AnalysisObjectManager::RemoveObject(const Text_t * name, Bool_t del)
{
...
TNamed * TGo4AnalysisObjectManager::GetObject(const Text_t * name, const Text_t* folder)
{
TRACE((11,"TGo4AnalysisObjectManager::GetObject(Text_t *)",__LINE__, __FILE__));
   //
   TNamed* ob=0;
   TFolder* searchfold;
...
Bool_t TGo4AnalysisObjectManager::ClearObjects(const Text_t * name)
{
   TRACE((11,"TGo4AnalysisObjectManager::ClearObject(Text_t *)",__LINE__, __FILE__));
   Bool_t rev=kTRUE;
...
Bool_t TGo4AnalysisObjectManager::DeleteObjects(const Text_t * name)
{
   Bool_t rev=kFALSE;
   TGo4LockGuard  dirguard(fxDirMutex);
   TObject* ob= fxGo4Dir->FindObjectAny(name);
...
Bool_t TGo4AnalysisObjectManager::ProtectObjects(const Text_t* name, const Option_t* flags)
{
   Bool_t rev = kFALSE;
   TGo4LockGuard  dirguard(fxDirMutex);
   TObject* ob= fxGo4Dir->FindObjectAny(name);
...
TRACE((11,"TGo4AnalysisObjectManager::CreateTreeStructure(TTree*)",__LINE__, __FILE__));
   ...
   if(thetree)
      {
         const Text_t* treename=thetree->GetName();
         const Text_t* treetitle=thetree->GetTitle();
...
TGo4TreeStructure * TGo4AnalysisObjectManager::CreateTreeStructure(const Text_t* treename)
{
TRACE((11,"TGo4AnalysisObjectManager::CreateTreeStructure(const Text_t *)",__LINE__, __FILE__));
   TTree* thetree=0;
   if(fxTreeDir)
      {
   ...
   while((nob=miter()) !=0) {
       ...
       // later, we might scan these recursively
        ...
        switch(mem->GetArrayDim()) {
           case 1:
             snprintf(buffer,500,"%s[%d]",
                mem->GetName(),mem->GetMaxIndex(0));
             break;

           case 2:
             snprintf(buffer,500,"%s[%d][%d]",
                mem->GetName(),mem->GetMaxIndex(0),mem->GetMaxIndex(1));
             break;

           default:
               snprintf(buffer,500,"%s",mem->GetName());
        }

       TGo4MemberStatus* state = new TGo4MemberStatus(buffer, mem->GetFullTypeName());
       nameslist->AddLast(state);
    } // while
...
Bool_t TGo4AnalysisObjectManager::AddHistogram(TH1 * his, const Text_t* subfolder, Bool_t replace)
{
...
Bool_t TGo4AnalysisObjectManager::AddTree(TTree* tree, const Text_t* subfolder)
{
TRACE((11,"TGo4AnalysisObjectManager::AddTree(TTree*, Text_t*)",__LINE__, __FILE__));
  return (AddObjectToFolder(tree,fxTreeDir,subfolder,kFALSE));
}

Bool_t TGo4AnalysisObjectManager::RemoveTree(TTree * tree, const Text_t* stepname)
{
   TRACE((11,"TGo4AnalysisObjectManager::RemoveTree(TTree*, Text_t*)",__LINE__, __FILE__));
   Bool_t rev=kFALSE;
   if(tree)
      {
               TGo4LockGuard listguard(fxDirMutex);
                  fxTreeDir->Remove(tree);
                  // later: we use directory with name stepname to put tree in
      }
   else
      {
         rev=kFALSE;
...
{
TRACE((11,"TGo4AnalysisObjectManager::GetHistogram(Text_t *)",__LINE__, __FILE__));
...
TTree * TGo4AnalysisObjectManager::GetTree(const Text_t * name)
{
TRACE((11,"TGo4AnalysisObjectManager::GetTree(Text_t *)",__LINE__, __FILE__));
  return dynamic_cast<TTree*> (FindObjectInFolder(fxTreeDir, name));
}

Bool_t TGo4AnalysisObjectManager::RemoveHistogram(const Text_t * name, Bool_t del)
{
TRACE((11,"TGo4AnalysisObjectManager::RemoveHistogram(Text_t*)",__LINE__, __FILE__));
   //
   return RemoveObjectFromFolder(name, fxHistogramDir, del);
}


Bool_t TGo4AnalysisObjectManager::AddAnalysisCondition(TGo4Condition * con, const Text_t* subfolder)
{
...
Bool_t TGo4AnalysisObjectManager::SetAnalysisCondition(const Text_t * name, TGo4Condition* con,
                                   Bool_t counter, TFolder* parent)
{
TRACE((11,"TGo4AnalysisObjectManager::SetAnalysisCondition(Text_t*, TGo4Condition*, Bool_t)",__LINE__, __FILE__));
TGo4LockGuard   listguard(fxDirMutex);
Bool_t rev=kFALSE;
TFolder* topfolder=0;
if(parent)
      ...
      if(oldcon!=0)
      ...
      else
         {
            // condition not yet exisiting, add external condition
             ...
             // find out destination folder for new condition from name:
            Text_t subfolder[fguSUBFOLDERMAXLEN];
            size_t fnamelen=0;
            const char* endname = name;
            const char* foldername = name;
            while (endname!=0)
               {
                  endname=strstr(foldername,"/");
                  if(endname==0) break;
                  clonedcon->SetName(endname+1);
                  fnamelen= endname-name; // length of path string
                  //cout <<"SetAnalysiscondition: namelen="<< (Int_t) fnamelen << endl;
                  foldername=endname+1;
               }

             if(fnamelen>0)
                {
                   // we have a subfolder for condition
                   if(fnamelen>fguSUBFOLDERMAXLEN) fnamelen=fguSUBFOLDERMAXLEN;
                   snprintf(subfolder,fnamelen+1,"%s",name);
                   rev=AddObjectToFolder(clonedcon,topfolder,subfolder,kTRUE,kFALSE,kFALSE);
                   //cout << "++++ Added new condition "<< clonedcon->GetName()<<" to folder "<<topfolder->GetName()<<"/"<< subfolder << endl;
                }
             else
                {
                   // no subfolder, condition is directly under topfolder
                   rev=AddObjectToFolder(clonedcon,topfolder,0,kTRUE,kFALSE,kFALSE);
                   //cout << "++++ Added new condition "<< clonedcon->GetName()<<" to folder "<<topfolder->GetName()<<", no subfolder!!!"<< endl;
                }
         }
   }
else
...
{
TRACE((11,"TGo4AnalysisObjectManager::GetAnalysisCondition(Text_t*)",__LINE__, __FILE__));
...
TGo4WinCond* TGo4AnalysisObjectManager::MakeWindowCond(const Text_t* foldername,
                                                       const Text_t* conditionname,
                                                       Double_t      xlow,
                                                       Double_t      xup,
                                                       const Text_t* bindhistogram,
                                                       Bool_t        invert) {
...
TGo4PolyCond* TGo4AnalysisObjectManager::MakePolyCond(const Text_t* foldername,
                                                      const Text_t* conditionname,
                                                      Int_t         size,
                                                      Float_t      (*points)[2],
                                                      const Text_t* bindhistogram,
...
Bool_t TGo4AnalysisObjectManager::RemoveAnalysisCondition(const Text_t * name)
{
TRACE((11,"TGo4AnalysisObjectManager::RemoveAnalysisCondition(Text_t*)",__LINE__, __FILE__));
   return RemoveObjectFromFolder(name, fxConditionDir, kTRUE);
}

TGo4ObjectStatus * TGo4AnalysisObjectManager::CreateObjectStatus(const Text_t * name, const Text_t* folder)
{
...
{
TRACE((11,"TGo4AnalysisObjectManager::GetEvenStructure(Text_t *)",__LINE__, __FILE__));
...
Bool_t TGo4AnalysisObjectManager::AddParameter(TGo4Parameter * par, const Text_t* subfolder)
{
...
Bool_t TGo4AnalysisObjectManager::SetParameter(const Text_t * name, TGo4Parameter * par, TFolder* parent)
{
TRACE((11,"TGo4AnalysisObjectManager::SetParameter(Text_t*, TGo4Parameter*)",__LINE__, __FILE__));
Bool_t rev=kFALSE;
TFolder* topfolder=0;
if(parent)
   topfolder=parent;
else
   topfolder=fxParameterDir;
if(par)
   {
            ...
            if(fnamelen>0)
                {
                   // we have a subfolder for condition
                   if(fnamelen>fguSUBFOLDERMAXLEN) fnamelen=fguSUBFOLDERMAXLEN;
                   snprintf(subfolder,fnamelen,"%s",name);
                   rev=AddObjectToFolder(clonedpar,topfolder,subfolder,kTRUE);
             ...
             else
                {
                   ...
                   //cout << "++++ Added new parameter "<< clonedpar->GetName()<<" to folder "<<topfolder->GetName()<<", no subfolder!!!"<< endl;
                }
         }
   }
else
...
{
TRACE((11,"TGo4AnalysisObjectManager::GetParameter(Text_t*)",__LINE__, __FILE__));
...
Bool_t TGo4AnalysisObjectManager::RemoveParameter(const Text_t * name)
{
TRACE((11,"TGo4AnalysisObjectManager::RemoveParameter(Text_t*)",__LINE__, __FILE__));
   return RemoveObjectFromFolder(name, fxParameterDir, kTRUE);
}

Bool_t TGo4AnalysisObjectManager::AddPicture(TGo4Picture * pic, const Text_t* subfolder)
{
...
Bool_t TGo4AnalysisObjectManager::SetPicture(const Text_t * name, TGo4Picture * pic, TFolder* parent)
{
TRACE((11,"TGo4AnalysisObjectManager::SetPicture(Text_t*, TGo4Picture*)",__LINE__, __FILE__));
Bool_t rev=kFALSE;
TFolder* topfolder=0;
if(parent)
   topfolder=parent;
            ...
            if(fnamelen>0)
                {
                   ...
                   if(fnamelen>fguSUBFOLDERMAXLEN) fnamelen=fguSUBFOLDERMAXLEN;
                   snprintf(subfolder,fnamelen,"%s",name);
                   rev=AddObjectToFolder(clonedpic,topfolder,subfolder,kTRUE);
                }
             else
                {
                   // no subfolder, condition is directly under topfolder
...
{
TRACE((11,"TGo4AnalysisObjectManager::GetPicture(Text_t*)",__LINE__, __FILE__));
...
Bool_t TGo4AnalysisObjectManager::RemovePicture(const Text_t * name)
{
TRACE((11,"TGo4AnalysisObjectManager::RemovePicture(Text_t*)",__LINE__, __FILE__));
   return RemoveObjectFromFolder(name, fxPictureDir, kTRUE);
}

Bool_t TGo4AnalysisObjectManager::AddCanvas(TCanvas * can, const Text_t* subfolder)
{
...
TCanvas * TGo4AnalysisObjectManager::GetCanvas(const Text_t * name)
{
TRACE((11,"TGo4AnalysisObjectManager::GetPicture(Text_t*)",__LINE__, __FILE__));
...
Bool_t TGo4AnalysisObjectManager::RemoveCanvas(const Text_t * name)
{
TRACE((11,"TGo4AnalysisObjectManager::RemovePicture(Text_t*)",__LINE__, __FILE__));
...
{
TRACE((11,"TGo4AnalysisObjectManager::AddTreeHistogram(Text_t*,...)",__LINE__, __FILE__));
  //
   Bool_t rev=kFALSE;
...
TFolder* TGo4AnalysisObjectManager::FindSubFolder(TFolder* parent, const Text_t* subfolder, Bool_t create)
{
TRACE((11,"TGo4AnalysisObjectManager::FindSubFolder(TFolder*, const Text_t*, Bool_t)",__LINE__, __FILE__));
TGo4LockGuard  dirguard(fxDirMutex);
   TFolder* result=0;
...
Bool_t TGo4AnalysisObjectManager::AddObjectToFolder(TObject * ob,
                                                    ...
                                                    Bool_t resetbits)
{
TRACE((11,"TGo4AnalysisObjectManager::AddObjectToFolder(TObject *, TFolder*, const Text_t*, Bool_t)",__LINE__, __FILE__));
      ...
      if(resetbits)
         {
            ...
            ob->ResetBit(TGo4Status::kGo4CanDelete); // default behaviour: allow reset, disable delete
         }
      Text_t obname[fguSUBFOLDERMAXLEN];
      Text_t subname[fguSUBFOLDERMAXLEN];
      if(subfolder)
         {
            // prepare given name of subfolder:
            snprintf(subname,fguSUBFOLDERMAXLEN,"%s",subfolder);
            Text_t* lastchar=subname + strlen(subname)-1;
            if (*lastchar=='/')
               *lastchar = 0;
/*            if(!strcmp("/",lastchar))
               {
                  // last character of foldername is slash, ignore it!
                  snprintf(lastchar,1,"\0");
               }
*/
            snprintf(obname,fguSUBFOLDERMAXLEN,"%s/%s",subname,ob->GetName());
         }
      else
         {
            snprintf(obname,fguSUBFOLDERMAXLEN,"%s",ob->GetName());
         }
      ...
      if(uniquename)
      ...
      else
         {
            ...
            oldob= fold->FindObjectAny(obname);
         }
      if(oldob)
    ...
    if(subfolder)
       {
         ...
         if(addDir==0)
            {
            // should not happen: all specified subfolders should be created!
            addDir=fold;
            }
       }
    else
...
//
   ...
   Text_t buffer[fguSUBFOLDERMAXLEN];
   if(fullname) {
            ...
            if(subfolder)
               {
                  ...
                  const Text_t* subfoldername=subfolder->GetName();
...
Int_t TGo4AnalysisObjectManager::PrintFolder(TFolder* fold, Option_t* opt, const Text_t* expression)
{
   if(fold==0) return 0;
...
void TGo4AnalysisObjectManager::PrintConditions(const Text_t* expression)
{
...
void TGo4AnalysisObjectManager::PrintHistograms(const Text_t* expression)
{
...
TObject* TGo4AnalysisObjectManager::NextMatchingObject(const Text_t* expr,
                        const Text_t* folder,
                        Bool_t reset)
{
   if(reset) {
...
TList* TGo4AnalysisObjectManager::CreateObjectList(const Text_t* expr, const Text_t* folder)
{
TGo4LockGuard  dirguard(fxDirMutex);
TFolder* searchfold;
if(folder==0 || !strcmp(folder,fgcTOPFOLDER))
...
TList* TGo4AnalysisObjectManager::CreateObjectList(const Text_t* expr, TFolder* fold)
{
...
Bool_t TGo4AnalysisObjectManager::IsMatching(const Text_t* string, const Text_t* expression)
{
...
TObject* TGo4AnalysisObjectManager::FindObjectInFolder(TFolder*      folder,
                                                       const Text_t* fullname)
{
   TRACE((12,"TGo4AnalysisObjectManager::FindObjectInFolder(TFolder*, const Text_t*)",__LINE__, __FILE__));
   TGo4LockGuard  listguard(fxDirMutex);
...
TObject* TGo4AnalysisObjectManager::TestObject(TFolder*     folder,
                                               const Text_t* &pathname,
                                               const Text_t* objectname,
                                               const TClass* cl)
{
   TString fullname;
