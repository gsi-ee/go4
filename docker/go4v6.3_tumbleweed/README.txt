...
This package contains a Dockerfile with Go4 6.3.0 and ROOT 6.28.12 under OpenSuse Tumbleweed system.
...
and unpack it:
$ tar zxvf go4v6.3_tumbleweed.tar.gz
...
--- JAM(j.adamczewski@gsi.de) 29-Apr-2024
