...
This package contains a Dockerfile with Go4 6.4.0 and ROOT 6.32.10 under OpenSuse Leap 15.5 system.
Go4 is build with Qt6 webcanvas and HDF5 support.
...
Many thanks to Joern Dreyer (j.dreyer@hzdr.de) of  Helmholtz Zentrum Dresden Rossendorf for adjusting the previous Dockerfile to Go4 6.3 and the most recent tumbleweed!
...
D:\docker\go4v6.4_leap> build_and_run.bat
...
--- JAM(j.adamczewski@gsi.de) 13-Mar-2025
