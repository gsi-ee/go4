   ...
   if (result == COMM__SUCCESS) {
      ...
      case COMM__GETHIST:
         ...
         if (mbshisto) {
            ...
            result = f_his_sendhis(mbshisto->GetHead(), mbshisto->GetHisNum(), (CHARS *)hisname,
      ...
      case COMM__GETDIR: {
         ...
         //               std::cout <<"\thisnum="<<mbshisto->GetHisNum()<<", buflen="<<mbshisto->GetBufLen() <<
         //               std::endl;
         delete mbshisto;
      } break;
      default:
