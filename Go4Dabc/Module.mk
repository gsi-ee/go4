...
$(GO4DABC_O) $(GO4DABC_DEP) $(GO4DABC_DS) $(GO4DABC_DO): INCLUDES += -I$(DABCINCPATH)

$(GO4DABC_LIB) : LDRPATHS += $(DABCLIBPATH)

GO4DABC_DEPLIB = $(DABCROOT_LIB) $(DABCHTTP_LIB) $(DABCBASE_LIB) $(ANAL_LIB_DEP)

$(GO4DABC_LIB):  MAKELIB_SET = $(LIBS_FULLSET) -L$(DABCLIBPATH) -lDabcBase -lDabcHttp -lDabcRoot

$(GO4DABC_DS): $(GO4DABC_DIR)/TGo4Sniffer.h $(GO4DABC_LINKDEF)
	@$(ROOTCINTGO4) $(GO4DABC_LIB) $(GO4DABC_DIR)/TGo4Sniffer.h $(GO4DABC_LINKDEF)

$(GO4DABC_LIB): $(GO4DABC_O) $(GO4DABC_DO) $(GO4DABC_DEPLIB)
	@$(MakeLibrary) $(GO4DABC_LIBNAME) "$(GO4DABC_O) $(GO4DABC_DO)" $(GO4DLLPATH) "$(GO4DABC_LINKDEF)" "$(GO4DABC_DEPLIB)" $(GO4DABC_DS) $(GO4DABC_DIR)/TGo4Sniffer.h
