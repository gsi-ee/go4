...
GO4DABC_DEPLIB = $(DABCROOT_LIB) $(DABCHTTP_LIB) $(DABCBASE_LIB) $(GO4ANBASE_LIB) $(GO4TSKH_LIB) $(THRDMNGR_LIB) $(GO4BASE_LIB) $(GO4FIT_LIB) $(BASIC_LIB_DEP)

$(GO4DABC_LIB):  MAKELIB_SET = $(LIBS_BASESET) -lGo4Fit -lGo4Base -lGo4ThreadManager -lGo4TaskHandler -lGo4AnalBase -L$(DABCLIBPATH) -lDabcBase -lDabcHttp -lDabcRoot
...
$(GO4DABC_LIB): $(GO4DABC_O) $(GO4DABC_DO) $(GO4DABC_DEPLIB)
	@$(MakeLibrary) $(GO4DABC_LIBNAME) "$(GO4DABC_O) $(GO4DABC_DO)" $(GO4DLLPATH) "$(GO4DABC_LINKDEF)" "$(GO4DABC_DEPLIB)" $(GO4DABC_DS) $(GO4DABC_DIR)/TGo4Dabc.h
