...
$(WEB6CANV_LIB):   MAKELIB_SET = $(LIBS_WEB6SET)

$(WEB6CANV_LIB): $(WEB6CANV_O) $(WEB6CANV_DO)
	@$(MakeLibrary) $(WEB6CANV_LIBNAME) "$(WEB6CANV_O) $(WEB6CANV_DO)" $(GO4DLLPATH) "$(WEB6CANV_LINKDEF)" "" $(WEB6CANV_DS) "$(WEB6CANV_H)"
