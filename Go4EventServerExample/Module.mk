...
$(EVENTSERVEXAMP_LIB):   $(EVENTSERVEXAMP_O) $(EVENTSERVEXAMP_DO)
	@$(MakeLib) $(EVENTSERVEXAMP_LIBNAME) "$(EVENTSERVEXAMP_O) $(EVENTSERVEXAMP_DO)" $(EVENTSERVEXAMP_DIR) $(EVENTSERVEXAMP_LINKDEF)

$(EVENTSERVEXAMP_DS): $(EVENTSERVEXAMP_H)  $(EVENTSERVEXAMP_LINKDEF)
	@$(ROOTCINTGO4) $(EVENTSERVEXAMP_H) $(EVENTSERVEXAMP_LINKDEF)

all-$(EVENTSERVEXAMP_NAME):     $(EVENTSERVEXAMP_LIB) $(EVENTSERVEXAMP_EXE)
