...
Int_t TMeshParameter::PrintParameter(Text_t * n, Int_t){
  ...
  cout << " fbUnpackOn="<<fbUnpackOn<<endl;
  cout << " fbExec1On="<<fbExec1On<<endl;
  cout << " fbExec2On="<<fbExec2On<<endl;
  cout << " fbExec3On="<<fbExec3On<<endl;
  cout << " fbExec12On="<<fbExec12On<<endl;
  cout << " fbCollectorOn="<<fbCollectorOn<<endl;
  return 0;
}
//-----------------------------------------------------------
Bool_t TMeshParameter::UpdateFrom(TGo4Parameter *pp){
  ...
  cout <<"Parameter "<<GetName()<<" changed steps setup" << endl;
