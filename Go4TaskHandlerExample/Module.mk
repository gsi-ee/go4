...
$(TASKHANDEXAMP_LIB):   $(TASKHANDEXAMP_O) $(TASKHANDEXAMP_DO)
	@$(MakeLibrary) $(TASKHANDEXAMP_LIBNAME) "$(TASKHANDEXAMP_O) $(TASKHANDEXAMP_DO)" $(TASKHANDEXAMP_DIR) $(TASKHANDEXAMP_LINKDEF) "$(GO4TSKH_LIB) $(THRDMNGR_LIB) $(GO4BASE_LIB) $(ROOTSYS)/lib/libThread.so"

$(TASKHANDEXAMP_DS): $(TASKHANDEXAMP_H)  $(TASKHANDEXAMP_LINKDEF)
		@$(ROOTCINTGO4) $(TASKHANDEXAMP_H) $(TASKHANDEXAMP_LINKDEF)

all-$(TASKHANDEXAMP_NAME):     $(TASKHANDEXAMP_LIB) $(TASKHANDEXAMP_EXE1) $(TASKHANDEXAMP_EXE2)
