...
$(TASKHANDEXAMP_LIB):   $(TASKHANDEXAMP_O) $(TASKHANDEXAMP_DO)
	@$(MakeLib) $(TASKHANDEXAMP_LIBNAME) "$(TASKHANDEXAMP_O) $(TASKHANDEXAMP_DO)" $(TASKHANDEXAMP_DIR) $(TASKHANDEXAMP_LINKDEF) "$(GO4TSKH_SLIB) $(THRDMNGR_SLIB) $(GO4BASE_SLIB) $(ROOTSYS)/lib/libThread.so"
