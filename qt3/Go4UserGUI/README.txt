...
NOTE that the Go4 analyis library libGo4Analysis.so needs to be specified
...
This whill create libgo4plugin.so library in $GO4SYS/Go4plugin directory.
This file should be copied to $QTDIR/plugins/designer directory 
(this may require root privelegies).
...
2. User gui library should always inlclude StartUserGui(void*)
