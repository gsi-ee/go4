...
**
** Created: Mo Jan 31 12:38:03 2011
**
    ...
    : QGo4Widget( parent, name )
{
    ...
    dabcNodeBox->setSizePolicy( QSizePolicy( (QSizePolicy::SizeType)7, (QSizePolicy::SizeType)7, 0, 0, dabcNodeBox->sizePolicy().hasHeightForWidth() ) );
    dabcNodeBox->setMinimumSize( QSize( 320, 0 ) );
    dabcNodeBox->setColumnLayout(0, Qt::Vertical );
    dabcNodeBox->layout()->setSpacing( 6 );
    dabcNodeBox->layout()->setMargin( 11 );
    dabcNodeBoxLayout = new QGridLayout( dabcNodeBox->layout() );
    dabcNodeBoxLayout->setAlignment( Qt::AlignTop );

    NodeTable = new QGo4Table( dabcNodeBox, "NodeTable" );
    NodeTable->setMinimumSize( QSize( 300, 0 ) );
    ...
    dabcNodeBoxLayout->addWidget( NodeTable, 0, 0 );

    TGo4DabcMonitorLayout->addMultiCellWidget( dabcNodeBox, 0, 1, 1, 1 );

    ratemeterBox = new QGroupBox( this, "ratemeterBox" );
    ratemeterBox->setSizePolicy( QSizePolicy( (QSizePolicy::SizeType)7, (QSizePolicy::SizeType)7, 0, 0, ratemeterBox->sizePolicy().hasHeightForWidth() ) );
    ratemeterBox->setMinimumSize( QSize( 320, 0 ) );
    ...
    RateTable->setMinimumSize( QSize( 300, 0 ) );
    ...
    TGo4DabcMonitorLayout->addItem( spacer2, 2, 0 );
    ...
    MoreCheck = new QCheckBox( dnsBox, "MoreCheck" );
    dnsBoxLayout->addWidget( MoreCheck );
    ...
    languageChange();
    resize( QSize(879, 309).expandedTo(minimumSizeHint()) );
    ...
    connect( MoreCheck, SIGNAL( toggled(bool) ), controlBox, SLOT( setShown(bool) ) );
    init();
}
...
void TGo4DabcMonitor::languageChange()
{
    ...
    MoreCheck->setText( tr( "more..." ) );
    QToolTip::add( MoreCheck, tr( "Check to show Inspector and histogram controls" ) );
    ...
    HistogramCheck->setText( tr( "histogramming on" ) );
