...
void TGo4EditDynEntry::ResetWidget()
{
   ...
   RefreshButton->setIconSet( QIconSet( QPixmap::fromMimeSource( "right" ) ) );
...
{
   TString objname;
   TGo4ServerProxy* an = Browser()->DefineAnalysisObject(HistoNameLbl->text().latin1(), objname);
   if (an!=0) {
