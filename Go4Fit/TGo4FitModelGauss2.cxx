...
Bool_t TGo4FitModelGauss2::BeforeEval(Int_t ndim)
{
   ...
   if (Par_sig1 == 0.) {
      std::cout << " TGo4FitModelGauss2:: invalid Sig0 value" << std::endl;
      return kFALSE;
   }
   Par_sig2 = GetPar(4)->GetValue();
   if (Par_sig2 == 0.) {
      std::cout << " TGo4FitModelGauss2:: invalid Sig1 value" << std::endl;
      return kFALSE;
   }
   ...
   if ((fiNaxis1 >= ndim) || (fiNaxis2 >= ndim)) {
      std::cout << " TGo4FitModelGauss2:: invalid index value" << std::endl;
      return kFALSE;
   }
   return kTRUE;
}
